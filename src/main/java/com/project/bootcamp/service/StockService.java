...
public class StockService {
    ...
    @Transactional //Anotação responsável por fazer transações com o banco de dados(neste método seria o INSERT no BD)
    ...
    @Transactional(readOnly = true) //Transação apenas de leitura de dados do BD
